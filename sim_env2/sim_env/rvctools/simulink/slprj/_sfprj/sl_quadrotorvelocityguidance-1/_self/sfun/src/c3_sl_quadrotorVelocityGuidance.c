...
#include "c3_sl_quadrotorVelocityGuidance.h"
...
static void initialize_c3_sl_quadrotorVelocityGuidance
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance);
static void initialize_params_c3_sl_quadrotorVelocityGuidance
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance);
static void enable_c3_sl_quadrotorVelocityGuidance
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance);
static void disable_c3_sl_quadrotorVelocityGuidance
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_sl_quadrotorVelocityGuidance
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_sl_quadrotorVelocityGuidance
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance);
static void set_sim_state_c3_sl_quadrotorVelocityGuidance
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance, const mxArray
   *c3_st);
static void finalize_c3_sl_quadrotorVelocityGuidance
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance);
static void sf_gateway_c3_sl_quadrotorVelocityGuidance
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance);
static void mdl_start_c3_sl_quadrotorVelocityGuidance
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance);
static void c3_chartstep_c3_sl_quadrotorVelocityGuidance
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance);
static void initSimStructsc3_sl_quadrotorVelocityGuidance
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance);
...
static real_T c3_mpower(SFc3_sl_quadrotorVelocityGuidanceInstanceStruct
  *chartInstance, real_T c3_a);
static void c3_eml_scalar_eg(SFc3_sl_quadrotorVelocityGuidanceInstanceStruct
  *chartInstance);
static void c3_eml_error(SFc3_sl_quadrotorVelocityGuidanceInstanceStruct
  *chartInstance);
static void c3_eye(SFc3_sl_quadrotorVelocityGuidanceInstanceStruct
                   *chartInstance, real_T c3_I[225]);
static void c3_eml_switch_helper(SFc3_sl_quadrotorVelocityGuidanceInstanceStruct
  *chartInstance);
static void c3_eml_extremum(SFc3_sl_quadrotorVelocityGuidanceInstanceStruct
  *chartInstance, real_T c3_x[15], real_T *c3_extremum, int32_T *c3_indx);
static void c3_check_forloop_overflow_error
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance, boolean_T
   c3_overflow);
...
static uint8_T c3_k_emlrt_marshallIn
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance, const mxArray
   *c3_b_is_active_c3_sl_quadrotorVelocityGuidance, const char_T *c3_identifier);
  ...
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_sl_quadrotorVelocityGuidance = 0U;
}
  ...
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance)
{
  ...
  c3_c_hoistedGlobal =
    chartInstance->c3_is_active_c3_sl_quadrotorVelocityGuidance;
   ...
   *c3_st)
{
  ...
  *chartInstance->c3_route_cost = c3_e_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c3_is_active_c3_sl_quadrotorVelocityGuidance =
    ...
    "is_active_c3_sl_quadrotorVelocityGuidance");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_sl_quadrotorVelocityGuidance(chartInstance);
  ...
  (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_sl_quadrotorVelocityGuidance(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance;
  chartInstance = (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c3_sl_quadrotorVelocityGuidance_get_eml_resolved_functions_info(void)
{
   ...
   *c3_b_is_active_c3_sl_quadrotorVelocityGuidance, const char_T *c3_identifier)
{
  ...
  c3_y = c3_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_sl_quadrotorVelocityGuidance), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_sl_quadrotorVelocityGuidance);
  return c3_y;
}
...
void sf_c3_sl_quadrotorVelocityGuidance_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_sl_quadrotorVelocityGuidance_get_post_codegen_info(void);
mxArray *sf_c3_sl_quadrotorVelocityGuidance_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c3_sl_quadrotorVelocityGuidance_get_post_codegen_info();
...
mxArray *sf_c3_sl_quadrotorVelocityGuidance_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_sl_quadrotorVelocityGuidance_jit_fallback_info(void)
{
...
mxArray *sf_c3_sl_quadrotorVelocityGuidance_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_sl_quadrotorVelocityGuidance(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[11],T\"PSIwp_route\",},{M[1],M[5],T\"Xwp_route\",},{M[1],M[9],T\"Ywp_route\",},{M[1],M[10],T\"Zwp_route\",},{M[1],M[12],T\"route\",},{M[1],M[13],T\"route_cost\",},{M[4],M[0],T\"firstentry\",S'l','i','p'{{M1x2[219 229],M[0],}}},{M[8],M[0],T\"is_active_c3_sl_quadrotorVelocityGuidance\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_sl_quadrotorVelocityGuidance_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c3_sl_quadrotorVelocityGuidance(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_sl_quadrotorVelocityGuidanceInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_sl_quadrotorVelocityGuidance
    ((SFc3_sl_quadrotorVelocityGuidanceInstanceStruct*) chartInstanceVar);
  initialize_c3_sl_quadrotorVelocityGuidance
    ((SFc3_sl_quadrotorVelocityGuidanceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_sl_quadrotorVelocityGuidance(void
  *chartInstanceVar)
{
  enable_c3_sl_quadrotorVelocityGuidance
    ((SFc3_sl_quadrotorVelocityGuidanceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_sl_quadrotorVelocityGuidance(void
  *chartInstanceVar)
{
  disable_c3_sl_quadrotorVelocityGuidance
    ((SFc3_sl_quadrotorVelocityGuidanceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_sl_quadrotorVelocityGuidance(void
  *chartInstanceVar)
{
  sf_gateway_c3_sl_quadrotorVelocityGuidance
    ((SFc3_sl_quadrotorVelocityGuidanceInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_sl_quadrotorVelocityGuidance
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_sl_quadrotorVelocityGuidance
    ((SFc3_sl_quadrotorVelocityGuidanceInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_sl_quadrotorVelocityGuidance(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_sl_quadrotorVelocityGuidance
    ((SFc3_sl_quadrotorVelocityGuidanceInstanceStruct*)chartInfo->chartInstance,
     st);
}

static void sf_opaque_terminate_c3_sl_quadrotorVelocityGuidance(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_sl_quadrotorVelocityGuidanceInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_sl_quadrotorVelocityGuidance
      ((SFc3_sl_quadrotorVelocityGuidanceInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_sl_quadrotorVelocityGuidance
    ((SFc3_sl_quadrotorVelocityGuidanceInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_sl_quadrotorVelocityGuidance(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_sl_quadrotorVelocityGuidance
      ((SFc3_sl_quadrotorVelocityGuidanceInstanceStruct*)
       (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_sl_quadrotorVelocityGuidance(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_sl_quadrotorVelocityGuidance(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_sl_quadrotorVelocityGuidance(SimStruct *S)
{
  SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_sl_quadrotorVelocityGuidanceInstanceStruct *)utMalloc
    (sizeof(SFc3_sl_quadrotorVelocityGuidanceInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_sl_quadrotorVelocityGuidance;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_sl_quadrotorVelocityGuidance;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_sl_quadrotorVelocityGuidance;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_sl_quadrotorVelocityGuidance;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_sl_quadrotorVelocityGuidance;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_sl_quadrotorVelocityGuidance;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_sl_quadrotorVelocityGuidance;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_sl_quadrotorVelocityGuidance;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_sl_quadrotorVelocityGuidance;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_sl_quadrotorVelocityGuidance;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_sl_quadrotorVelocityGuidance;
...
void c3_sl_quadrotorVelocityGuidance_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_sl_quadrotorVelocityGuidance(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_sl_quadrotorVelocityGuidance(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_sl_quadrotorVelocityGuidance(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_sl_quadrotorVelocityGuidance_method_dispatcher.\n"
