...
#include "c5_sl_quadrotorPositionGuidance.h"
...
static void initialize_c5_sl_quadrotorPositionGuidance
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void initialize_params_c5_sl_quadrotorPositionGuidance
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void enable_c5_sl_quadrotorPositionGuidance
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void disable_c5_sl_quadrotorPositionGuidance
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_sl_quadrotorPositionGuidance
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_sl_quadrotorPositionGuidance
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void set_sim_state_c5_sl_quadrotorPositionGuidance
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance, const mxArray
   *c5_st);
static void finalize_c5_sl_quadrotorPositionGuidance
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void sf_gateway_c5_sl_quadrotorPositionGuidance
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void mdl_start_c5_sl_quadrotorPositionGuidance
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void initSimStructsc5_sl_quadrotorPositionGuidance
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
...
static uint8_T c5_c_emlrt_marshallIn
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance, const mxArray
   *c5_b_is_active_c5_sl_quadrotorPositionGuidance, const char_T *c5_identifier);
  ...
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_sl_quadrotorPositionGuidance = 0U;
}
  ...
  (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance)
{
  ...
  c5_hoistedGlobal = chartInstance->c5_is_active_c5_sl_quadrotorPositionGuidance;
   ...
   *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_sl_quadrotorPositionGuidance =
    c5_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 0)),
    "is_active_c5_sl_quadrotorPositionGuidance");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_sl_quadrotorPositionGuidance(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance;
  chartInstance = (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *)
    chartInstanceVoid;
   ...
   *c5_b_is_active_c5_sl_quadrotorPositionGuidance, const char_T *c5_identifier)
{
  ...
  c5_y = c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_sl_quadrotorPositionGuidance), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_sl_quadrotorPositionGuidance);
  return c5_y;
}
...
void sf_c5_sl_quadrotorPositionGuidance_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c5_sl_quadrotorPositionGuidance_get_post_codegen_info(void);
mxArray *sf_c5_sl_quadrotorPositionGuidance_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c5_sl_quadrotorPositionGuidance_get_post_codegen_info();
...
mxArray *sf_c5_sl_quadrotorPositionGuidance_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_sl_quadrotorPositionGuidance_jit_fallback_info(void)
{
...
mxArray *sf_c5_sl_quadrotorPositionGuidance_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_sl_quadrotorPositionGuidance(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c5_sl_quadrotorPositionGuidance\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 1, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_sl_quadrotorPositionGuidance_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_sl_quadrotorPositionGuidance(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_sl_quadrotorPositionGuidanceInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_sl_quadrotorPositionGuidance
    ((SFc5_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
  initialize_c5_sl_quadrotorPositionGuidance
    ((SFc5_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_sl_quadrotorPositionGuidance(void
  *chartInstanceVar)
{
  enable_c5_sl_quadrotorPositionGuidance
    ((SFc5_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_sl_quadrotorPositionGuidance(void
  *chartInstanceVar)
{
  disable_c5_sl_quadrotorPositionGuidance
    ((SFc5_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_sl_quadrotorPositionGuidance(void
  *chartInstanceVar)
{
  sf_gateway_c5_sl_quadrotorPositionGuidance
    ((SFc5_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c5_sl_quadrotorPositionGuidance
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c5_sl_quadrotorPositionGuidance
    ((SFc5_sl_quadrotorPositionGuidanceInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_sl_quadrotorPositionGuidance(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c5_sl_quadrotorPositionGuidance
    ((SFc5_sl_quadrotorPositionGuidanceInstanceStruct*)chartInfo->chartInstance,
     st);
}

static void sf_opaque_terminate_c5_sl_quadrotorPositionGuidance(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_sl_quadrotorPositionGuidanceInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_sl_quadrotorPositionGuidance
      ((SFc5_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_sl_quadrotorPositionGuidance
    ((SFc5_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_sl_quadrotorPositionGuidance(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_sl_quadrotorPositionGuidance(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_sl_quadrotorPositionGuidance(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_sl_quadrotorPositionGuidance(SimStruct *S)
{
  SFc5_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_sl_quadrotorPositionGuidanceInstanceStruct *)utMalloc
    (sizeof(SFc5_sl_quadrotorPositionGuidanceInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_sl_quadrotorPositionGuidance;
...
void c5_sl_quadrotorPositionGuidance_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_sl_quadrotorPositionGuidance(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_sl_quadrotorPositionGuidance(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_sl_quadrotorPositionGuidance(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_sl_quadrotorPositionGuidance_method_dispatcher.\n"
