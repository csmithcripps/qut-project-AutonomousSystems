...
#include "c4_sl_quadrotorPositionGuidance.h"
...
static void initialize_c4_sl_quadrotorPositionGuidance
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void initialize_params_c4_sl_quadrotorPositionGuidance
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void enable_c4_sl_quadrotorPositionGuidance
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void disable_c4_sl_quadrotorPositionGuidance
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_sl_quadrotorPositionGuidance
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_sl_quadrotorPositionGuidance
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void set_sim_state_c4_sl_quadrotorPositionGuidance
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance, const mxArray
   *c4_st);
static void finalize_c4_sl_quadrotorPositionGuidance
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void sf_gateway_c4_sl_quadrotorPositionGuidance
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void mdl_start_c4_sl_quadrotorPositionGuidance
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
static void initSimStructsc4_sl_quadrotorPositionGuidance
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance);
...
static real_T c4_mpower(SFc4_sl_quadrotorPositionGuidanceInstanceStruct
  *chartInstance, real_T c4_a);
static void c4_eml_scalar_eg(SFc4_sl_quadrotorPositionGuidanceInstanceStruct
  *chartInstance);
static void c4_eml_error(SFc4_sl_quadrotorPositionGuidanceInstanceStruct
  *chartInstance);
...
static uint8_T c4_f_emlrt_marshallIn
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance, const mxArray
   *c4_b_is_active_c4_sl_quadrotorPositionGuidance, const char_T *c4_identifier);
  ...
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_sl_quadrotorPositionGuidance = 0U;
}
  ...
  (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance)
{
  ...
  c4_h_hoistedGlobal =
    chartInstance->c4_is_active_c4_sl_quadrotorPositionGuidance;
   ...
   *c4_st)
{
  ...
  *chartInstance->c4_z_star = c4_c_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c4_is_active_c4_sl_quadrotorPositionGuidance =
    ...
    "is_active_c4_sl_quadrotorPositionGuidance");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_sl_quadrotorPositionGuidance(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance;
  chartInstance = (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *)
    chartInstanceVoid;
   ...
   *c4_b_is_active_c4_sl_quadrotorPositionGuidance, const char_T *c4_identifier)
{
  ...
  c4_y = c4_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_sl_quadrotorPositionGuidance), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_sl_quadrotorPositionGuidance);
  return c4_y;
}
...
void sf_c4_sl_quadrotorPositionGuidance_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c4_sl_quadrotorPositionGuidance_get_post_codegen_info(void);
mxArray *sf_c4_sl_quadrotorPositionGuidance_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c4_sl_quadrotorPositionGuidance_get_post_codegen_info();
...
mxArray *sf_c4_sl_quadrotorPositionGuidance_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_sl_quadrotorPositionGuidance_jit_fallback_info(void)
{
...
mxArray *sf_c4_sl_quadrotorPositionGuidance_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_sl_quadrotorPositionGuidance(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[5],T\"WP_indexOut\",},{M[1],M[15],T\"psi_star\",},{M[1],M[16],T\"stop_simulation\",},{M[1],M[12],T\"x_star\",},{M[1],M[13],T\"y_star\",},{M[1],M[14],T\"z_star\",},{M[4],M[0],T\"firstentry\",S'l','i','p'{{M1x2[347 357],M[0],}}},{M[8],M[0],T\"is_active_c4_sl_quadrotorPositionGuidance\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_sl_quadrotorPositionGuidance_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c4_sl_quadrotorPositionGuidance(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_sl_quadrotorPositionGuidanceInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_sl_quadrotorPositionGuidance
    ((SFc4_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
  initialize_c4_sl_quadrotorPositionGuidance
    ((SFc4_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_sl_quadrotorPositionGuidance(void
  *chartInstanceVar)
{
  enable_c4_sl_quadrotorPositionGuidance
    ((SFc4_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_sl_quadrotorPositionGuidance(void
  *chartInstanceVar)
{
  disable_c4_sl_quadrotorPositionGuidance
    ((SFc4_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_sl_quadrotorPositionGuidance(void
  *chartInstanceVar)
{
  sf_gateway_c4_sl_quadrotorPositionGuidance
    ((SFc4_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_sl_quadrotorPositionGuidance
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c4_sl_quadrotorPositionGuidance
    ((SFc4_sl_quadrotorPositionGuidanceInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_sl_quadrotorPositionGuidance(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c4_sl_quadrotorPositionGuidance
    ((SFc4_sl_quadrotorPositionGuidanceInstanceStruct*)chartInfo->chartInstance,
     st);
}

static void sf_opaque_terminate_c4_sl_quadrotorPositionGuidance(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_sl_quadrotorPositionGuidanceInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_sl_quadrotorPositionGuidance
      ((SFc4_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_sl_quadrotorPositionGuidance
    ((SFc4_sl_quadrotorPositionGuidanceInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_sl_quadrotorPositionGuidance(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_sl_quadrotorPositionGuidance(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_sl_quadrotorPositionGuidance(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_sl_quadrotorPositionGuidance(SimStruct *S)
{
  SFc4_sl_quadrotorPositionGuidanceInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_sl_quadrotorPositionGuidanceInstanceStruct *)utMalloc
    (sizeof(SFc4_sl_quadrotorPositionGuidanceInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_sl_quadrotorPositionGuidance;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_sl_quadrotorPositionGuidance;
...
void c4_sl_quadrotorPositionGuidance_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_sl_quadrotorPositionGuidance(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_sl_quadrotorPositionGuidance(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_sl_quadrotorPositionGuidance(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_sl_quadrotorPositionGuidance_method_dispatcher.\n"
