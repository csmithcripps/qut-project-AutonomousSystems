...
function sys = mdlOutputs(t,u,s, plot, enable, quad)
	...
	d = d*10; %Troy B. - Increased the size here to make the quad easier to see
	r = r*10;
    ...
    if enable == 1
        ...
        for i = 1:quad.nrotors
          ...
          %  plot3([hub(1,i)+tippath(1,:,i)],[hub(2,i)+tippath(2,:,i)],[hub(3,i)+tippath(3,:,i)],'b-')
            ...
            plot3([hub(1,i)],[hub(2,i)],[hub(3,i)],'b-')
      ...
      %TB added    %plot x and y line to show the position more clearly
       plot3([z(1) z(1)],[-z(2) s],[0 0],'--k')
       plot3([z(1) z(1)],[-z(2) -s],[0 0],'--k')                  
             
       plot3([z(1) s],[-z(2) -z(2)],[0 0],'--k')
       plot3([z(1) -s],[-z(2) -z(2)],[0 0],'--k')         
