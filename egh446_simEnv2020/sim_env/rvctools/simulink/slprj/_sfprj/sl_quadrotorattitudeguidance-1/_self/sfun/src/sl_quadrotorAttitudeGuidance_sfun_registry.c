...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_sl_quadrotorAttitudeGuidance_process_check_sum_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_sl_quadrotorAttitudeGuidance_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "sl_quadrotorAttitudeGuidance") == 0) {
    sf_sl_quadrotorAttitudeGuidance_uses_exported_functions(nlhs, plhs, nrhs-2,
      prhs+2);
    return 1;
  }
...
{
  extern unsigned int sf_sl_quadrotorAttitudeGuidance_autoinheritance_info( int
  ...
  if (strcmp(machineName, "sl_quadrotorAttitudeGuidance") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_sl_quadrotorAttitudeGuidance_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_sl_quadrotorAttitudeGuidance_third_party_uses_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "sl_quadrotorAttitudeGuidance") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_sl_quadrotorAttitudeGuidance_third_party_uses_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_sl_quadrotorAttitudeGuidance_jit_fallback_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "sl_quadrotorAttitudeGuidance") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_sl_quadrotorAttitudeGuidance_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_sl_quadrotorAttitudeGuidance_updateBuildInfo_args_info(
    int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "sl_quadrotorAttitudeGuidance") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_sl_quadrotorAttitudeGuidance_updateBuildInfo_args_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_sl_quadrotorAttitudeGuidance_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "sl_quadrotorAttitudeGuidance") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_sl_quadrotorAttitudeGuidance_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
unsigned int sf_process_get_post_codegen_info(int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[])
{
  extern void sf_sl_quadrotorAttitudeGuidance_get_post_codegen_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  machineName[(sizeof(machineName)/sizeof(char)-1)] = '\0';
  if (strcmp(machineName, "sl_quadrotorAttitudeGuidance") == 0) {
    sf_sl_quadrotorAttitudeGuidance_get_post_codegen_info(nlhs, plhs, nrhs-2,
      prhs+2);
    return 1;
  }
...
extern unsigned int sf_sl_quadrotorAttitudeGuidance_method_dispatcher(SimStruct *
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"sl_quadrotorAttitudeGuidance")) {
    return(sf_sl_quadrotorAttitudeGuidance_method_dispatcher(simstructPtr,
...
extern void sl_quadrotorAttitudeGuidance_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    sl_quadrotorAttitudeGuidance_terminator();
...
extern void sl_quadrotorAttitudeGuidance_initializer(void);
extern void sl_quadrotorAttitudeGuidance_register_exported_symbols(SimStruct* S);
extern void sl_quadrotorAttitudeGuidance_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  sl_quadrotorAttitudeGuidance_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      sl_quadrotorAttitudeGuidance_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    sl_quadrotorAttitudeGuidance_initializer();
  }
