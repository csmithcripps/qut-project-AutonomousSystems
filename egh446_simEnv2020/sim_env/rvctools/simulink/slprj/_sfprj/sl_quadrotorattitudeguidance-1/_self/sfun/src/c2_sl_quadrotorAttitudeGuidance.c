...
#include "c2_sl_quadrotorAttitudeGuidance.h"
...
static const char * c2_debug_family_names[75] = { "V_max", "roll_limit",
  "pitch_limit", "dyaw", "dpitch", "droll", "Vg_b", "dx_b", "dy_b", "xL", "yL",
  "xt", "yt", "dxt", "dyt", "g", "deltax", "deltay", "deltaxdot", "deltaydot",
  "N", "ay", "dz_b", "the", "psi", "phi", "R", "Vel_I", "dx_n", "dy_n", "dz_n",
  "heading_body_unwrapped_temp", "heading_body_unwrapped",
  "heading_nav_unwrapped_temp", "heading_nav_unwrapped", "Vc", "alpha_bar",
  "law", "lambda_unwrapped", "Kpitch", "KIpitch", "nargin", "nargout", "x_star",
  "y_star", "z_star", "psi_star", "X", "loitercmd", "VerrorInt", "lambdaprev",
  "heading_body_prev", "heading_nav_prev", "pitch_star", "roll_star", "yaw_star",
  "hgt_star", "lambda", "lambdadot", "rtilde", "Verror", "heading_nav",
  "track_angle", "roll", "pitch", "yaw", "x", "y", "z", "Vg_n", "heading_body",
  "ay_n", "ay_b", "Vg_star", "tgo" };

/* Function Declarations */
static void initialize_c2_sl_quadrotorAttitudeGuidance
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance);
static void initialize_params_c2_sl_quadrotorAttitudeGuidance
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance);
static void enable_c2_sl_quadrotorAttitudeGuidance
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance);
static void disable_c2_sl_quadrotorAttitudeGuidance
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_sl_quadrotorAttitudeGuidance
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_sl_quadrotorAttitudeGuidance
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance);
static void set_sim_state_c2_sl_quadrotorAttitudeGuidance
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_sl_quadrotorAttitudeGuidance
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance);
static void sf_gateway_c2_sl_quadrotorAttitudeGuidance
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance);
static void mdl_start_c2_sl_quadrotorAttitudeGuidance
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance);
static void c2_chartstep_c2_sl_quadrotorAttitudeGuidance
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance);
static void initSimStructsc2_sl_quadrotorAttitudeGuidance
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance);
...
static real_T c2_emlrt_marshallIn
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance, const mxArray
   *c2_b_tgo, const char_T *c2_identifier);
...
static void c2_c_emlrt_marshallIn
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[2]);
...
static void c2_d_emlrt_marshallIn
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[3]);
...
static void c2_e_emlrt_marshallIn
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[9]);
...
static real_T c2_mpower(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
  *chartInstance, real_T c2_a);
static void c2_eml_scalar_eg(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
  *chartInstance);
static real_T c2_sqrt(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
                      *chartInstance, real_T c2_b_x);
static void c2_eml_error(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
  *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
  *chartInstance);
static void c2_eml_xgemm(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
  *chartInstance, real_T c2_A[9], real_T c2_B[3], real_T c2_C[3], real_T c2_b_C
  [3]);
static real_T c2_atan2(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
  *chartInstance, real_T c2_b_y, real_T c2_b_x);
static void c2_unwrap(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
                      *chartInstance, real_T c2_p[2], real_T c2_b_p[2]);
static boolean_T c2_isfinite(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
  *chartInstance, real_T c2_b_x);
static real_T c2_abs(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
                     *chartInstance, real_T c2_b_x);
static real_T c2_sign(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
                      *chartInstance, real_T c2_b_x);
...
static uint8_T c2_g_emlrt_marshallIn
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance, const mxArray
   *c2_b_is_active_c2_sl_quadrotorAttitudeGuidance, const char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sqrt(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
                      *chartInstance, real_T *c2_b_x);
static void c2_b_eml_xgemm(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
  *chartInstance, real_T c2_A[9], real_T c2_B[3], real_T c2_C[3]);
static void c2_b_unwrap(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
  *chartInstance, real_T c2_p[2]);
static void c2_b_sign(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct
                      *chartInstance, real_T *c2_b_x);
  ...
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_sl_quadrotorAttitudeGuidance = 0U;
}
  ...
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance)
{
  ...
  c2_j_hoistedGlobal = *chartInstance->c2_lambdadot;
  c2_j_u = c2_j_hoistedGlobal;
  c2_l_y = NULL;
  sf_mex_assign(&c2_l_y, sf_mex_create("y", &c2_j_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 9, c2_l_y);
  c2_k_hoistedGlobal = *chartInstance->c2_pitch;
  c2_k_u = c2_k_hoistedGlobal;
  c2_m_y = NULL;
  sf_mex_assign(&c2_m_y, sf_mex_create("y", &c2_k_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 10, c2_m_y);
  c2_l_hoistedGlobal = *chartInstance->c2_pitch_star;
  c2_l_u = c2_l_hoistedGlobal;
  c2_n_y = NULL;
  sf_mex_assign(&c2_n_y, sf_mex_create("y", &c2_l_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 11, c2_n_y);
  c2_m_hoistedGlobal = *chartInstance->c2_roll;
  c2_m_u = c2_m_hoistedGlobal;
  c2_o_y = NULL;
  sf_mex_assign(&c2_o_y, sf_mex_create("y", &c2_m_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 12, c2_o_y);
  c2_n_hoistedGlobal = *chartInstance->c2_roll_star;
  c2_n_u = c2_n_hoistedGlobal;
  c2_p_y = NULL;
  sf_mex_assign(&c2_p_y, sf_mex_create("y", &c2_n_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 13, c2_p_y);
  c2_o_hoistedGlobal = *chartInstance->c2_rtilde;
  c2_o_u = c2_o_hoistedGlobal;
  c2_q_y = NULL;
  sf_mex_assign(&c2_q_y, sf_mex_create("y", &c2_o_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 14, c2_q_y);
  c2_p_hoistedGlobal = *chartInstance->c2_tgo;
  c2_p_u = c2_p_hoistedGlobal;
  c2_r_y = NULL;
  sf_mex_assign(&c2_r_y, sf_mex_create("y", &c2_p_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 15, c2_r_y);
  c2_q_hoistedGlobal = *chartInstance->c2_track_angle;
  c2_q_u = c2_q_hoistedGlobal;
  c2_s_y = NULL;
  sf_mex_assign(&c2_s_y, sf_mex_create("y", &c2_q_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 16, c2_s_y);
  c2_r_hoistedGlobal = *chartInstance->c2_x;
  c2_r_u = c2_r_hoistedGlobal;
  c2_t_y = NULL;
  sf_mex_assign(&c2_t_y, sf_mex_create("y", &c2_r_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 17, c2_t_y);
  c2_s_hoistedGlobal = *chartInstance->c2_y;
  c2_s_u = c2_s_hoistedGlobal;
  c2_u_y = NULL;
  sf_mex_assign(&c2_u_y, sf_mex_create("y", &c2_s_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 18, c2_u_y);
  c2_t_hoistedGlobal = *chartInstance->c2_yaw;
  c2_t_u = c2_t_hoistedGlobal;
  c2_v_y = NULL;
  sf_mex_assign(&c2_v_y, sf_mex_create("y", &c2_t_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 19, c2_v_y);
  c2_u_hoistedGlobal = *chartInstance->c2_yaw_star;
  c2_u_u = c2_u_hoistedGlobal;
  c2_w_y = NULL;
  sf_mex_assign(&c2_w_y, sf_mex_create("y", &c2_u_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 20, c2_w_y);
  c2_v_hoistedGlobal = *chartInstance->c2_z;
  c2_v_u = c2_v_hoistedGlobal;
  c2_x_y = NULL;
  sf_mex_assign(&c2_x_y, sf_mex_create("y", &c2_v_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 21, c2_x_y);
  c2_w_hoistedGlobal =
    chartInstance->c2_is_active_c2_sl_quadrotorAttitudeGuidance;
  c2_w_u = c2_w_hoistedGlobal;
  c2_y_y = NULL;
  sf_mex_assign(&c2_y_y, sf_mex_create("y", &c2_w_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_b_y, 22, c2_y_y);
   ...
   *c2_st)
{
  ...
  *chartInstance->c2_Verror = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 0)), "Verror");
  *chartInstance->c2_Vg_n = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 1)), "Vg_n");
  *chartInstance->c2_Vg_star = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 2)), "Vg_star");
  *chartInstance->c2_ay_b = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 3)), "ay_b");
  *chartInstance->c2_ay_n = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 4)), "ay_n");
  *chartInstance->c2_heading_body = c2_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 5)), "heading_body");
  *chartInstance->c2_heading_nav = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 6)), "heading_nav");
  *chartInstance->c2_hgt_star = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 7)), "hgt_star");
  *chartInstance->c2_lambda = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 8)), "lambda");
  *chartInstance->c2_lambdadot = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 9)), "lambdadot");
  *chartInstance->c2_pitch = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 10)), "pitch");
  *chartInstance->c2_pitch_star = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 11)), "pitch_star");
  *chartInstance->c2_roll = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 12)), "roll");
  *chartInstance->c2_roll_star = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 13)), "roll_star");
  *chartInstance->c2_rtilde = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 14)), "rtilde");
  *chartInstance->c2_tgo = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 15)), "tgo");
  *chartInstance->c2_track_angle = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 16)), "track_angle");
  *chartInstance->c2_x = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 17)), "x");
  *chartInstance->c2_y = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 18)), "y");
  *chartInstance->c2_yaw = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 19)), "yaw");
  *chartInstance->c2_yaw_star = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 20)), "yaw_star");
  *chartInstance->c2_z = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 21)), "z");
  chartInstance->c2_is_active_c2_sl_quadrotorAttitudeGuidance =
    c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 22)),
    "is_active_c2_sl_quadrotorAttitudeGuidance");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_sl_quadrotorAttitudeGuidance(chartInstance);
  ...
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_x_star, 0U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_y_star, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_z_star, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_psi_star, 3U);
  for (c2_i0 = 0; c2_i0 < 12; c2_i0++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c2_X)[c2_i0], 4U);
  }

  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_loitercmd, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_VerrorInt, 6U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_sl_quadrotorAttitudeGuidance(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_sl_quadrotorAttitudeGuidanceMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_pitch_star, 7U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_roll_star, 8U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_yaw_star, 9U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_hgt_star, 10U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_lambda, 11U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_lambdadot, 12U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_rtilde, 13U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Verror, 14U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_heading_nav, 15U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_track_angle, 16U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_roll, 17U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_pitch, 18U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_yaw, 19U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_x, 20U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_y, 21U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_z, 22U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Vg_n, 23U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_heading_body, 24U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_ay_n, 25U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_ay_b, 26U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_lambdaprev, 27U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Vg_star, 28U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_tgo, 29U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_heading_body_prev, 30U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_heading_nav_prev, 31U);
}
  ...
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance)
{
  ...
  real_T c2_b_y_star;
  real_T c2_b_z_star;
  real_T c2_b_psi_star;
  int32_T c2_i1;
  real_T c2_b_X[12];
  real_T c2_b_loitercmd;
  real_T c2_b_VerrorInt;
  real_T c2_b_lambdaprev;
  real_T c2_b_heading_body_prev;
  real_T c2_b_heading_nav_prev;
  uint32_T c2_debug_family_var_map[75];
  real_T c2_V_max;
  real_T c2_roll_limit;
  real_T c2_pitch_limit;
  real_T c2_dyaw;
  real_T c2_dpitch;
  real_T c2_droll;
  real_T c2_Vg_b;
  ...
  real_T c2_dy_n;
  real_T c2_dz_n;
  real_T c2_heading_body_unwrapped_temp[2];
  real_T c2_heading_body_unwrapped;
  real_T c2_heading_nav_unwrapped_temp[2];
  real_T c2_heading_nav_unwrapped;
  real_T c2_Vc;
  real_T c2_alpha_bar;
  real_T c2_law;
  real_T c2_lambda_unwrapped[2];
  real_T c2_Kpitch;
  real_T c2_KIpitch;
  real_T c2_nargin = 10.0;
  real_T c2_nargout = 22.0;
  real_T c2_b_pitch_star;
  real_T c2_b_roll_star;
  real_T c2_b_yaw_star;
  real_T c2_b_hgt_star;
  real_T c2_b_lambda;
  real_T c2_b_lambdadot;
  real_T c2_b_rtilde;
  real_T c2_b_Verror;
  real_T c2_b_heading_nav;
  real_T c2_b_track_angle;
  real_T c2_b_roll;
  real_T c2_b_pitch;
  real_T c2_b_yaw;
  real_T c2_b_x;
  ...
  c2_hoistedGlobal = *chartInstance->c2_x_star;
  c2_b_hoistedGlobal = *chartInstance->c2_y_star;
  c2_c_hoistedGlobal = *chartInstance->c2_z_star;
  c2_d_hoistedGlobal = *chartInstance->c2_psi_star;
  c2_e_hoistedGlobal = *chartInstance->c2_loitercmd;
  c2_f_hoistedGlobal = *chartInstance->c2_VerrorInt;
  c2_g_hoistedGlobal = *chartInstance->c2_lambdaprev;
  c2_h_hoistedGlobal = *chartInstance->c2_heading_body_prev;
  c2_i_hoistedGlobal = *chartInstance->c2_heading_nav_prev;
  c2_b_x_star = c2_hoistedGlobal;
  c2_b_y_star = c2_b_hoistedGlobal;
  c2_b_z_star = c2_c_hoistedGlobal;
  c2_b_psi_star = c2_d_hoistedGlobal;
  for (c2_i1 = 0; c2_i1 < 12; c2_i1++) {
    c2_b_X[c2_i1] = (*chartInstance->c2_X)[c2_i1];
  }

  c2_b_loitercmd = c2_e_hoistedGlobal;
  c2_b_VerrorInt = c2_f_hoistedGlobal;
  c2_b_lambdaprev = c2_g_hoistedGlobal;
  c2_b_heading_body_prev = c2_h_hoistedGlobal;
  c2_b_heading_nav_prev = c2_i_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 75U, 75U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_V_max, 0U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_roll_limit, 1U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_pitch_limit, 2U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dyaw, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dpitch, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_droll, 5U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Vg_b, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dx_b, 7U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dy_b, 8U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_xL, 9U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_yL, 10U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_xt, 11U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_yt, 12U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dxt, 13U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dyt, 14U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_g, 15U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_deltax, 16U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_deltay, 17U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_deltaxdot, 18U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_deltaydot, 19U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_N, 20U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_ay, 21U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dz_b, 22U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_the, 23U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_psi, 24U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_phi, 25U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_R, 26U, c2_e_sf_marshallOut,
    c2_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_Vel_I, 27U, c2_d_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dx_n, 28U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dy_n, 29U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_dz_n, 30U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_heading_body_unwrapped_temp, 31U,
    c2_c_sf_marshallOut, c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_heading_body_unwrapped, 32U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_heading_nav_unwrapped_temp, 33U,
    c2_c_sf_marshallOut, c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_heading_nav_unwrapped, 34U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Vc, 35U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_alpha_bar, 36U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_law, 37U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_lambda_unwrapped, 38U,
    c2_c_sf_marshallOut, c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Kpitch, 39U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_KIpitch, 40U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargin, 41U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 42U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_x_star, 43U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_y_star, 44U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_z_star, 45U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_psi_star, 46U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_b_X, 47U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_loitercmd, 48U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_VerrorInt, 49U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_lambdaprev, 50U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_heading_body_prev, 51U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_heading_nav_prev, 52U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_pitch_star, 53U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_roll_star, 54U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_yaw_star, 55U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_hgt_star, 56U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_lambda, 57U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_lambdadot, 58U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_rtilde, 59U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_Verror, 60U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_heading_nav, 61U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_track_angle, 62U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_roll, 63U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_pitch, 64U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_yaw, 65U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_x, 66U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_y, 67U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_z, 68U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_Vg_n, 69U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_heading_body, 70U,
    c2_sf_marshallOut, c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_ay_n, 71U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_ay_b, 72U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_Vg_star, 73U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_tgo, 74U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 16);
  c2_V_max = 10.0;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 17);
  c2_roll_limit = 0.3490658503988659;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 18);
  c2_pitch_limit = 0.17453292519943295;
  ...
  c2_d0 = c2_mpower(chartInstance, c2_dx_b) + c2_mpower(chartInstance, c2_dy_b);
  ...
  c2_R[0] = c2_d_x * c2_f_x;
  c2_R[3] = c2_h_x * c2_j_x * c2_l_x - c2_n_x * c2_p_x;
  c2_R[6] = c2_r_x * c2_t_x * c2_v_x + c2_x_x * c2_ab_x;
  c2_R[1] = c2_cb_x * c2_eb_x;
  c2_R[4] = c2_gb_x * c2_ib_x * c2_kb_x + c2_mb_x * c2_ob_x;
  c2_R[7] = c2_qb_x * c2_sb_x * c2_ub_x - c2_wb_x * c2_yb_x;
  c2_R[2] = -c2_bc_x;
  c2_R[5] = c2_dc_x * c2_fc_x;
  c2_R[8] = c2_hc_x * c2_jc_x;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 124);
  for (c2_i2 = 0; c2_i2 < 9; c2_i2++) {
    c2_a[c2_i2] = c2_R[c2_i2];
  }
  ...
  c2_b_eml_xgemm(chartInstance, c2_b_a, c2_b_b, c2_dv0);
  for (c2_i8 = 0; c2_i8 < 3; c2_i8++) {
    c2_Vel_I[c2_i8] = c2_dv0[c2_i8];
  }
  ...
  c2_d1 = c2_mpower(chartInstance, c2_dx_n) + c2_mpower(chartInstance, c2_dy_n);
  c2_b_sqrt(chartInstance, &c2_d1);
  c2_b_Vg_n = c2_d1;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 132U);
  c2_b_heading_nav = c2_atan2(chartInstance, c2_dy_n, c2_dx_n);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 133U);
  c2_b_heading_body = c2_atan2(chartInstance, c2_dy_b, c2_dx_b);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 147U);
  c2_dv1[0] = c2_b_heading_body_prev;
  c2_dv1[1] = c2_b_heading_body;
  c2_b_unwrap(chartInstance, c2_dv1);
  for (c2_i9 = 0; c2_i9 < 2; c2_i9++) {
    c2_heading_body_unwrapped_temp[c2_i9] = c2_dv1[c2_i9];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 148U);
  c2_heading_body_unwrapped = c2_heading_body_unwrapped_temp[1];
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 150U);
  c2_dv1[0] = c2_b_heading_nav_prev;
  c2_dv1[1] = c2_b_heading_nav;
  c2_b_unwrap(chartInstance, c2_dv1);
  for (c2_i10 = 0; c2_i10 < 2; c2_i10++) {
    c2_heading_nav_unwrapped_temp[c2_i10] = c2_dv1[c2_i10];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 151U);
  c2_heading_nav_unwrapped = c2_heading_nav_unwrapped_temp[1];
  ...
  c2_b_track_angle = c2_atan2(chartInstance, c2_b_y, c2_b_x);
  ...
  c2_deltax = c2_xt - c2_b_x;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 168U);
  c2_deltay = c2_yt - c2_b_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 170U);
  c2_b_lambda = c2_atan2(chartInstance, c2_deltay, c2_deltax);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 172U);
  c2_deltaxdot = c2_dxt - c2_dx_n;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 173U);
  c2_deltaydot = c2_dyt - c2_dy_n;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 174U);
  c2_A = c2_deltax * c2_deltaydot - c2_deltay * c2_deltaxdot;
  c2_B = c2_mpower(chartInstance, c2_deltax) + c2_mpower(chartInstance,
    c2_deltay);
  c2_kc_x = c2_A;
  c2_e_y = c2_B;
  c2_lc_x = c2_kc_x;
  ...
  c2_mc_x = c2_lc_x;
  c2_g_y = c2_f_y;
  c2_b_lambdadot = c2_mc_x / c2_g_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 176U);
  c2_d2 = c2_mpower(chartInstance, c2_deltaxdot) + c2_mpower(chartInstance,
    c2_deltaydot);
  c2_b_sqrt(chartInstance, &c2_d2);
  c2_Vc = c2_d2;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 177U);
  c2_d3 = c2_mpower(chartInstance, c2_deltax) + c2_mpower(chartInstance,
    c2_deltay);
  ...
  c2_pc_x = c2_oc_x;
  c2_j_y = c2_i_y;
  c2_b_tgo = c2_pc_x / c2_j_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 180U);
  if (CV_EML_IF(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, c2_Vc, 0.0, -1, 0U, c2_Vc
        == 0.0))) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 181U);
    c2_b_tgo = c2_b_rtilde;
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 184U);
  c2_c_A = c2_b_psi_star * 3.1415926535897931;
  c2_qc_x = c2_c_A;
  c2_rc_x = c2_qc_x;
  c2_sc_x = c2_rc_x;
  c2_alpha_bar = c2_sc_x / 180.0;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 194U);
  c2_b_Vg_star = c2_V_max;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 202U);
  if (CV_EML_IF(0, 1, 1, CV_RELATIONAL_EVAL(4U, 0U, 1, c2_b_loitercmd, 100.0, -1,
        0U, c2_b_loitercmd == 100.0))) {
    ...
    c2_d4 = c2_mpower(chartInstance, c2_deltax) + c2_mpower(chartInstance,
      c2_deltay);
    c2_b_sqrt(chartInstance, &c2_d4);
    c2_b_rtilde = c2_d4;
    ...
    CV_EML_IF(0, 1, 2, CV_RELATIONAL_EVAL(4U, 0U, 2, c2_law, 1.0, -1, 0U, c2_law
               == 1.0));
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 387);
    CV_EML_IF(0, 1, 5, CV_RELATIONAL_EVAL(4U, 0U, 5, c2_law, 2.0, -1, 0U, c2_law
               == 2.0));
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 389);
    c2_N = 3.0;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 390);
    c2_ay = c2_Vc * 3.0 * c2_b_lambdadot;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 393);
    c2_dv1[0] = c2_b_lambdaprev;
    c2_dv1[1] = c2_b_lambda;
    c2_b_unwrap(chartInstance, c2_dv1);
    for (c2_i11 = 0; c2_i11 < 2; c2_i11++) {
      c2_lambda_unwrapped[c2_i11] = c2_dv1[c2_i11];
    }

    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 394);
    c2_b_yaw_star = c2_lambda_unwrapped[1];
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 396);
    c2_b_roll_star = c2_atan2(chartInstance, c2_ay, 9.81);
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 399);
    c2_b_yaw_star = c2_heading_nav_unwrapped;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 428);
    c2_Kpitch = 0.5;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 429);
    c2_b_Verror = c2_b_Vg_n - c2_b_Vg_star;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 430);
    c2_KIpitch = 0.0;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 431);
    c2_b_pitch_star = 0.5 * c2_b_Verror + 0.0 * c2_b_VerrorInt;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 433);
    c2_d5 = c2_abs(chartInstance, c2_b_roll_star);
    if (CV_EML_IF(0, 1, 7, CV_RELATIONAL_EVAL(4U, 0U, 7, c2_d5, c2_roll_limit,
          -1, 4U, c2_d5 > c2_roll_limit))) {
      _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 434);
      c2_d6 = c2_b_roll_star;
      c2_b_sign(chartInstance, &c2_d6);
      c2_b_roll_star = c2_d6 * 0.3490658503988659;
    }

    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 437);
    c2_d7 = c2_abs(chartInstance, c2_b_pitch_star);
    if (CV_EML_IF(0, 1, 8, CV_RELATIONAL_EVAL(4U, 0U, 8, c2_d7, c2_pitch_limit,
          -1, 4U, c2_d7 > c2_pitch_limit))) {
      _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 438);
      c2_d8 = c2_b_pitch_star;
      c2_b_sign(chartInstance, &c2_d8);
      c2_b_pitch_star = c2_d8 * 0.17453292519943295;
    }

    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 444);
    c2_b_hgt_star = -c2_b_z_star;
  }
  ...
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -450);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c2_pitch_star = c2_b_pitch_star;
  *chartInstance->c2_roll_star = c2_b_roll_star;
  *chartInstance->c2_yaw_star = c2_b_yaw_star;
  *chartInstance->c2_hgt_star = c2_b_hgt_star;
  *chartInstance->c2_lambda = c2_b_lambda;
  *chartInstance->c2_lambdadot = c2_b_lambdadot;
  *chartInstance->c2_rtilde = c2_b_rtilde;
  *chartInstance->c2_Verror = c2_b_Verror;
  *chartInstance->c2_heading_nav = c2_b_heading_nav;
  *chartInstance->c2_track_angle = c2_b_track_angle;
  *chartInstance->c2_roll = c2_b_roll;
  *chartInstance->c2_pitch = c2_b_pitch;
  *chartInstance->c2_yaw = c2_b_yaw;
  *chartInstance->c2_x = c2_b_x;
  *chartInstance->c2_y = c2_b_y;
  *chartInstance->c2_z = c2_b_z;
  *chartInstance->c2_Vg_n = c2_b_Vg_n;
  *chartInstance->c2_heading_body = c2_b_heading_body;
  *chartInstance->c2_ay_n = c2_b_ay_n;
  *chartInstance->c2_ay_b = c2_b_ay_b;
  *chartInstance->c2_Vg_star = c2_b_Vg_star;
  *chartInstance->c2_tgo = c2_b_tgo;
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance;
  chartInstance = (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *)
    chartInstanceVoid;
   ...
   *c2_b_tgo, const char_T *c2_identifier)
{
  ...
  c2_b_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_tgo), &c2_thisId);
  sf_mex_destroy(&c2_b_tgo);
  return c2_b_y;
}
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  chartInstance = (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *)
    chartInstanceVoid;
  c2_b_tgo = sf_mex_dup(c2_mxArrayInData);
  ...
  *c2_inData)
{
  ...
  for (c2_i12 = 0; c2_i12 < 12; c2_i12++) {
    c2_b_inData[c2_i12] = (*(real_T (*)[12])c2_inData)[c2_i12];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i14 = 0; c2_i14 < 2; c2_i14++) {
    c2_b_inData[c2_i14] = (*(real_T (*)[2])c2_inData)[c2_i14];
  }
...
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  const mxArray *c2_lambda_unwrapped;
  const char_T *c2_identifier;
  emlrtMsgIdentifier c2_thisId;
  real_T c2_b_y[2];
  int32_T c2_i17;
  ...
  chartInstance = (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *)
    chartInstanceVoid;
  c2_lambda_unwrapped = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_lambda_unwrapped),
                        &c2_thisId, c2_b_y);
  sf_mex_destroy(&c2_lambda_unwrapped);
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  chartInstance = (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *)
    chartInstanceVoid;
  c2_Vel_I = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_Vel_I), &c2_thisId, c2_b_y);
  sf_mex_destroy(&c2_Vel_I);
  for (c2_i21 = 0; c2_i21 < 3; c2_i21++) {
    (*(real_T (*)[3])c2_outData)[c2_i21] = c2_b_y[c2_i21];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_R), &c2_thisId, c2_b_y);
  sf_mex_destroy(&c2_R);
  c2_i29 = 0;
  for (c2_i30 = 0; c2_i30 < 3; c2_i30++) {
    for (c2_i31 = 0; c2_i31 < 3; c2_i31++) {
      (*(real_T (*)[9])c2_outData)[c2_i31 + c2_i29] = c2_b_y[c2_i31 + c2_i29];
    }
  ...
  *sf_c2_sl_quadrotorAttitudeGuidance_get_eml_resolved_functions_info(void)
{
  ...
  sf_mex_assign(&c2_nameCaptureInfo, sf_mex_createstruct("structure", 2, 80, 1),
                false);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assert.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1389685374U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "resolved",
                  "resolved", 2);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1363681480U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/isBuiltInNumeric.m"),
                  "resolved", "resolved", 3);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1395899456U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_compatible.m"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286789996U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
                  "resolved", 5);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1386391552U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1363681478U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/ismatrix.m"), "resolved",
                  "resolved", 9);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1331272458U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m"), "resolved",
                  "resolved", 10);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1395296106U), "fileTimeLo",
                  "fileTimeLo", 10);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 10);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
                  "resolved", 16);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1363681454U), "fileTimeLo",
                  "fileTimeLo", 16);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 16);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286789926U), "fileTimeLo",
                  "fileTimeLo", 18);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 18);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286789938U), "fileTimeLo",
                  "fileTimeLo", 22);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 22);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m"), "resolved",
                  "resolved", 23);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1395296096U), "fileTimeLo",
                  "fileTimeLo", 23);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 23);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286789922U), "fileTimeLo",
                  "fileTimeLo", 24);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 24);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("sin"), "name", "name", 25);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 25);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m"), "resolved",
                  "resolved", 25);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1395296104U), "fileTimeLo",
                  "fileTimeLo", 25);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 25);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286789936U), "fileTimeLo",
                  "fileTimeLo", 26);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 26);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1383844894U), "fileTimeLo",
                  "fileTimeLo", 27);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 27);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1323138178U), "fileTimeLo",
                  "fileTimeLo", 29);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 29);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1393298458U), "fileTimeLo",
                  "fileTimeLo", 36);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 36);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("atan2"), "name", "name", 39);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 39);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286789920U), "fileTimeLo",
                  "fileTimeLo", 42);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 42);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("unwrap"), "name", "name", 43);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 43);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/unwrap.m"), "resolved",
                  "resolved", 43);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1343801588U), "fileTimeLo",
                  "fileTimeLo", 43);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 43);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, sf_mex_duplicatearraysafe(&c2_lhs43), "lhs", "lhs",
                  43);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/unwrap.m"), "context",
                  "context", 44);
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1307622442U), "fileTimeLo",
                  "fileTimeLo", 44);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 44);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1397228622U), "fileTimeLo",
                  "fileTimeLo", 46);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 46);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isfi.m"), "resolved",
                  "resolved", 47);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1346481558U), "fileTimeLo",
                  "fileTimeLo", 47);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 47);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isnumerictype.m"), "resolved",
                  "resolved", 48);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1398846798U), "fileTimeLo",
                  "fileTimeLo", 48);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 48);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
                  "resolved", 49);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1362229482U), "fileTimeLo",
                  "fileTimeLo", 49);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 49);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, sf_mex_duplicatearraysafe(&c2_lhs53), "lhs", "lhs",
                  53);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/unwrap.m!unwrap_vector"),
                  "context", "context", 54);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_scalar_eg"), "name",
                  "name", 54);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/unwrap.m!unwrap_vector"),
                  "context", "context", 55);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isfinite"), "name", "name", 55);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 55);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m"), "resolved",
                  "resolved", 55);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1363681456U), "fileTimeLo",
                  "fileTimeLo", 55);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 55);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m"), "context",
                  "context", 57);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isinf"), "name", "name", 57);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 57);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m"), "context",
                  "context", 59);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("isnan"), "name", "name", 59);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 59);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
                  "resolved", 59);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1363681458U), "fileTimeLo",
                  "fileTimeLo", 59);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 59);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/unwrap.m!unwrap_vector"),
                  "context", "context", 61);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("mod"), "name", "name", 61);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 61);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
...
static void c2_b_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1307622438U), "fileTimeLo",
                  "fileTimeLo", 67);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 67);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286789912U), "fileTimeLo",
                  "fileTimeLo", 68);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 68);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/mod.m!floatmod"), "context",
                  "context", 69);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eps"), "name", "name", 69);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 69);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "resolved",
                  "resolved", 69);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1326695596U), "fileTimeLo",
                  "fileTimeLo", 69);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 69);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1286789982U), "fileTimeLo",
                  "fileTimeLo", 70);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 70);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "context",
                  "context", 71);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_eps"), "name", "name", 71);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 71);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/unwrap.m!unwrap_vector"),
                  "context", "context", 73);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("abs"), "name", "name", 73);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 73);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "resolved",
                  "resolved", 73);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1363681452U), "fileTimeLo",
                  "fileTimeLo", 73);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 73);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, sf_mex_duplicatearraysafe(&c2_lhs75), "lhs", "lhs",
                  75);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(""), "context", "context", 76);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("abs"), "name", "name", 76);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 76);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "resolved",
  ...
  sf_mex_addfield(*c2_info, sf_mex_duplicatearraysafe(&c2_lhs76), "lhs", "lhs",
                  76);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(""), "context", "context", 77);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("sign"), "name", "name", 77);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 77);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1356509094U), "fileTimeLo",
                  "fileTimeLo", 79);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 79);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
                      ...
                      *chartInstance, real_T c2_b_x)
{
  real_T c2_c_x;
  c2_c_x = c2_b_x;
  c2_b_sqrt(chartInstance, &c2_c_x);
  return c2_c_x;
}
  ...
  *chartInstance)
{
  ...
  const mxArray *c2_c_y = NULL;
  (void)chartInstance;
  for (c2_i32 = 0; c2_i32 < 30; c2_i32++) {
    c2_u[c2_i32] = c2_cv0[c2_i32];
  }
  ...
  for (c2_i33 = 0; c2_i33 < 4; c2_i33++) {
    c2_b_u[c2_i33] = c2_cv1[c2_i33];
  }

  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", c2_b_u, 10, 0U, 1U, 0U, 2, 1, 4),
                false);
  ...
  *chartInstance, real_T c2_b_y, real_T c2_b_x)
{
  ...
  c2_c_y = c2_b_y;
  c2_c_x = c2_b_x;
  return muDoubleScalarAtan2(c2_c_y, c2_c_x);
}
                      ...
                      *chartInstance, real_T c2_p[2], real_T c2_b_p[2])
{
  ...
  for (c2_i37 = 0; c2_i37 < 2; c2_i37++) {
    c2_b_p[c2_i37] = c2_p[c2_i37];
  }

  c2_b_unwrap(chartInstance, c2_b_p);
}
                      ...
                      *chartInstance, real_T c2_b_x)
{
  real_T c2_c_x;
  c2_c_x = c2_b_x;
  c2_b_sign(chartInstance, &c2_c_x);
  return c2_c_x;
}
   ...
   *c2_b_is_active_c2_sl_quadrotorAttitudeGuidance, const char_T *c2_identifier)
{
  ...
  c2_b_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_sl_quadrotorAttitudeGuidance), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_sl_quadrotorAttitudeGuidance);
  return c2_b_y;
}
  ...
  *chartInstance, real_T c2_A[9], real_T c2_B[3], real_T c2_C[3])
{
  ...
  for (c2_i39 = 0; c2_i39 < 3; c2_i39++) {
    ...
    for (c2_i41 = 0; c2_i41 < 3; c2_i41++) {
      c2_C[c2_i39] += c2_A[c2_i40 + c2_i39] * c2_B[c2_i41];
      c2_i40 += 3;
    }
  }
}
  ...
  *chartInstance, real_T c2_p[2])
{
  ...
  boolean_T exitg2;
  boolean_T exitg3;
  c2_cumsum_dp_corr = 0.0;
  c2_k = 1.0;
  exitg3 = false;
  while ((exitg3 == false) && (c2_k < 2.0)) {
    if (!c2_isfinite(chartInstance, c2_p[_SFD_EML_ARRAY_BOUNDS_CHECK("",
          (int32_T)_SFD_INTEGER_CHECK("", c2_k), 1, 2, 1, 0) - 1])) {
      c2_k++;
    } else {
      exitg3 = true;
    }
  ...
  if (c2_k < 2.0) {
    c2_pkm1 = c2_p[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
      "", c2_k), 1, 2, 1, 0) - 1];
    do {
      exitg1 = 0;
      c2_k++;
      exitg2 = false;
      while ((exitg2 == false) && (c2_k <= 2.0)) {
        if (!c2_isfinite(chartInstance, c2_p[_SFD_EML_ARRAY_BOUNDS_CHECK("",
              (int32_T)_SFD_INTEGER_CHECK("", c2_k), 1, 2, 1, 0) - 1])) {
          c2_k++;
        } else {
      ...
      if (c2_k > 2.0) {
        ...
        c2_dp = c2_p[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
          ("", c2_k), 1, 2, 1, 0) - 1] - c2_pkm1;
        c2_b_x = c2_dp + 3.1415926535897931;
        c2_eml_scalar_eg(chartInstance);
        c2_xk = c2_b_x;
        c2_c_x = c2_xk;
        c2_eml_scalar_eg(chartInstance);
        c2_r = c2_c_x / 6.2831853071795862;
        c2_d_x = c2_r;
        c2_e_x = c2_d_x;
        ...
        if (c2_b_y <= 2.2204460492503131E-16 * c2_c_y) {
          ...
          c2_r = (c2_r - c2_i_x) * 6.2831853071795862;
        }

        c2_dps = c2_r - 3.1415926535897931;
        if (c2_dps == -3.1415926535897931) {
          if (c2_dp > 0.0) {
            c2_dps = 3.1415926535897931;
          }
        }
        ...
        if (c2_d_y >= 3.1415926535897931) {
          c2_cumsum_dp_corr += c2_dps - c2_dp;
        }

        c2_pkm1 = c2_p[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", c2_k), 1, 2, 1, 0) - 1];
        c2_p[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          c2_k), 1, 2, 1, 0) - 1] = c2_p[_SFD_EML_ARRAY_BOUNDS_CHECK("",
          (int32_T)_SFD_INTEGER_CHECK("", c2_k), 1, 2, 1, 0) - 1] +
          c2_cumsum_dp_corr;
      }
    } while (exitg1 == 0);
...
static void init_simulink_io_address
  (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance)
{
  chartInstance->c2_x_star = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c2_y_star = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_z_star = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c2_psi_star = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c2_X = (real_T (*)[12])ssGetInputPortSignal_wrapper
    (chartInstance->S, 4);
  chartInstance->c2_loitercmd = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 5);
  chartInstance->c2_VerrorInt = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 6);
  chartInstance->c2_pitch_star = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_roll_star = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c2_yaw_star = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c2_hgt_star = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 4);
  chartInstance->c2_lambda = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 5);
  chartInstance->c2_lambdadot = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 6);
  chartInstance->c2_rtilde = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 7);
  chartInstance->c2_Verror = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 8);
  chartInstance->c2_heading_nav = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 9);
  chartInstance->c2_track_angle = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 10);
  chartInstance->c2_roll = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 11);
  chartInstance->c2_pitch = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 12);
  chartInstance->c2_yaw = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 13);
  ...
  chartInstance->c2_z = (real_T *)ssGetOutputPortSignal_wrapper(chartInstance->S,
    16);
  chartInstance->c2_Vg_n = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 17);
  chartInstance->c2_heading_body = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 18);
  chartInstance->c2_ay_n = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 19);
  chartInstance->c2_ay_b = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 20);
  chartInstance->c2_lambdaprev = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 7);
  chartInstance->c2_Vg_star = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 21);
  chartInstance->c2_tgo = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 22);
  chartInstance->c2_heading_body_prev = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 8);
  chartInstance->c2_heading_nav_prev = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 9);
}
...
void sf_c2_sl_quadrotorAttitudeGuidance_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4207063252U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2031550671U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(788657474U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1006448429U);
}

mxArray* sf_c2_sl_quadrotorAttitudeGuidance_get_post_codegen_info(void);
mxArray *sf_c2_sl_quadrotorAttitudeGuidance_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("ErDgJbaMmNFupSsNSjFZqG");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c2_sl_quadrotorAttitudeGuidance_get_post_codegen_info();
...
mxArray *sf_c2_sl_quadrotorAttitudeGuidance_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_sl_quadrotorAttitudeGuidance_jit_fallback_info(void)
{
...
mxArray *sf_c2_sl_quadrotorAttitudeGuidance_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_sl_quadrotorAttitudeGuidance(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[14],T\"Verror\",},{M[1],M[26],T\"Vg_n\",},{M[1],M[35],T\"Vg_star\",},{M[1],M[40],T\"ay_b\",},{M[1],M[31],T\"ay_n\",},{M[1],M[29],T\"heading_body\",},{M[1],M[18],T\"heading_nav\",},{M[1],M[44],T\"hgt_star\",},{M[1],M[9],T\"lambda\",},{M[1],M[10],T\"lambdadot\",}}",
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[22],T\"pitch\",},{M[1],M[6],T\"pitch_star\",},{M[1],M[21],T\"roll\",},{M[1],M[20],T\"roll_star\",},{M[1],M[12],T\"rtilde\",},{M[1],M[38],T\"tgo\",},{M[1],M[43],T\"track_angle\",},{M[1],M[23],T\"x\",},{M[1],M[24],T\"y\",},{M[1],M[19],T\"yaw\",}}",
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[15],T\"yaw_star\",},{M[1],M[25],T\"z\",},{M[8],M[0],T\"is_active_c2_sl_quadrotorAttitudeGuidance\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 23, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_sl_quadrotorAttitudeGuidance_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"x_star");
          _SFD_SET_DATA_PROPS(1,1,1,0,"y_star");
          _SFD_SET_DATA_PROPS(2,1,1,0,"z_star");
          _SFD_SET_DATA_PROPS(3,1,1,0,"psi_star");
          _SFD_SET_DATA_PROPS(4,1,1,0,"X");
          _SFD_SET_DATA_PROPS(5,1,1,0,"loitercmd");
          _SFD_SET_DATA_PROPS(6,1,1,0,"VerrorInt");
          _SFD_SET_DATA_PROPS(7,2,0,1,"pitch_star");
          _SFD_SET_DATA_PROPS(8,2,0,1,"roll_star");
          _SFD_SET_DATA_PROPS(9,2,0,1,"yaw_star");
          _SFD_SET_DATA_PROPS(10,2,0,1,"hgt_star");
          _SFD_SET_DATA_PROPS(11,2,0,1,"lambda");
          _SFD_SET_DATA_PROPS(12,2,0,1,"lambdadot");
          _SFD_SET_DATA_PROPS(13,2,0,1,"rtilde");
          _SFD_SET_DATA_PROPS(14,2,0,1,"Verror");
          _SFD_SET_DATA_PROPS(15,2,0,1,"heading_nav");
          _SFD_SET_DATA_PROPS(16,2,0,1,"track_angle");
          _SFD_SET_DATA_PROPS(17,2,0,1,"roll");
          _SFD_SET_DATA_PROPS(18,2,0,1,"pitch");
          _SFD_SET_DATA_PROPS(19,2,0,1,"yaw");
          _SFD_SET_DATA_PROPS(20,2,0,1,"x");
          _SFD_SET_DATA_PROPS(21,2,0,1,"y");
          _SFD_SET_DATA_PROPS(22,2,0,1,"z");
          _SFD_SET_DATA_PROPS(23,2,0,1,"Vg_n");
          _SFD_SET_DATA_PROPS(24,2,0,1,"heading_body");
          _SFD_SET_DATA_PROPS(25,2,0,1,"ay_n");
          _SFD_SET_DATA_PROPS(26,2,0,1,"ay_b");
          _SFD_SET_DATA_PROPS(27,1,1,0,"lambdaprev");
          _SFD_SET_DATA_PROPS(28,2,0,1,"Vg_star");
          _SFD_SET_DATA_PROPS(29,2,0,1,"tgo");
          _SFD_SET_DATA_PROPS(30,1,1,0,"heading_body_prev");
          _SFD_SET_DATA_PROPS(31,1,1,0,"heading_nav_prev");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,14028);
        _SFD_CV_INIT_EML_IF(0,1,0,5887,5897,-1,5919);
        _SFD_CV_INIT_EML_IF(0,1,1,6446,6465,6632,13904);
        _SFD_CV_INIT_EML_IF(0,1,2,7512,7523,12216,12231);
        _SFD_CV_INIT_EML_IF(0,1,3,8439,8468,-1,8650);
        _SFD_CV_INIT_EML_IF(0,1,4,8723,8753,-1,8816);
        _SFD_CV_INIT_EML_IF(0,1,5,12216,12231,13097,13171);
        _SFD_CV_INIT_EML_IF(0,1,6,13097,13112,-1,13112);
        _SFD_CV_INIT_EML_IF(0,1,7,13580,13610,-1,13665);
        _SFD_CV_INIT_EML_IF(0,1,8,13675,13707,-1,13765);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,5890,5897,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,1,6449,6465,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,2,7515,7523,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,5,12223,12231,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,7,13583,13610,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,8,13678,13707,-1,4);
        ...
        _SFD_SET_DATA_COMPILED_PROPS(31,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c2_sf_marshallOut,(MexInFcnForType)NULL);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c2_x_star);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c2_y_star);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c2_z_star);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c2_psi_star);
        _SFD_SET_DATA_VALUE_PTR(4U, *chartInstance->c2_X);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c2_loitercmd);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c2_VerrorInt);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c2_pitch_star);
        _SFD_SET_DATA_VALUE_PTR(8U, chartInstance->c2_roll_star);
        _SFD_SET_DATA_VALUE_PTR(9U, chartInstance->c2_yaw_star);
        _SFD_SET_DATA_VALUE_PTR(10U, chartInstance->c2_hgt_star);
        _SFD_SET_DATA_VALUE_PTR(11U, chartInstance->c2_lambda);
        _SFD_SET_DATA_VALUE_PTR(12U, chartInstance->c2_lambdadot);
        _SFD_SET_DATA_VALUE_PTR(13U, chartInstance->c2_rtilde);
        _SFD_SET_DATA_VALUE_PTR(14U, chartInstance->c2_Verror);
        _SFD_SET_DATA_VALUE_PTR(15U, chartInstance->c2_heading_nav);
        _SFD_SET_DATA_VALUE_PTR(16U, chartInstance->c2_track_angle);
        _SFD_SET_DATA_VALUE_PTR(17U, chartInstance->c2_roll);
        _SFD_SET_DATA_VALUE_PTR(18U, chartInstance->c2_pitch);
        _SFD_SET_DATA_VALUE_PTR(19U, chartInstance->c2_yaw);
        _SFD_SET_DATA_VALUE_PTR(20U, chartInstance->c2_x);
        _SFD_SET_DATA_VALUE_PTR(21U, chartInstance->c2_y);
        _SFD_SET_DATA_VALUE_PTR(22U, chartInstance->c2_z);
        _SFD_SET_DATA_VALUE_PTR(23U, chartInstance->c2_Vg_n);
        _SFD_SET_DATA_VALUE_PTR(24U, chartInstance->c2_heading_body);
        _SFD_SET_DATA_VALUE_PTR(25U, chartInstance->c2_ay_n);
        _SFD_SET_DATA_VALUE_PTR(26U, chartInstance->c2_ay_b);
        _SFD_SET_DATA_VALUE_PTR(27U, chartInstance->c2_lambdaprev);
        _SFD_SET_DATA_VALUE_PTR(28U, chartInstance->c2_Vg_star);
        _SFD_SET_DATA_VALUE_PTR(29U, chartInstance->c2_tgo);
        _SFD_SET_DATA_VALUE_PTR(30U, chartInstance->c2_heading_body_prev);
        _SFD_SET_DATA_VALUE_PTR(31U, chartInstance->c2_heading_nav_prev);
      }
    } else {
...
{
  return "ZG72ZbkBHyFb4lb8DI6VhC";
}

static void sf_opaque_initialize_c2_sl_quadrotorAttitudeGuidance(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_sl_quadrotorAttitudeGuidance
    ((SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct*) chartInstanceVar);
  initialize_c2_sl_quadrotorAttitudeGuidance
    ((SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_sl_quadrotorAttitudeGuidance(void
  *chartInstanceVar)
{
  enable_c2_sl_quadrotorAttitudeGuidance
    ((SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_sl_quadrotorAttitudeGuidance(void
  *chartInstanceVar)
{
  disable_c2_sl_quadrotorAttitudeGuidance
    ((SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_sl_quadrotorAttitudeGuidance(void
  *chartInstanceVar)
{
  sf_gateway_c2_sl_quadrotorAttitudeGuidance
    ((SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_sl_quadrotorAttitudeGuidance
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_sl_quadrotorAttitudeGuidance
    ((SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_sl_quadrotorAttitudeGuidance(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_sl_quadrotorAttitudeGuidance
    ((SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct*)chartInfo->chartInstance,
     st);
}

static void sf_opaque_terminate_c2_sl_quadrotorAttitudeGuidance(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_sl_quadrotorAttitudeGuidance
      ((SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_sl_quadrotorAttitudeGuidance
    ((SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_sl_quadrotorAttitudeGuidance(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_sl_quadrotorAttitudeGuidance(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1575577003U));
  ssSetChecksum1(S,(1364484675U));
  ssSetChecksum2(S,(417020119U));
  ssSetChecksum3(S,(511854665U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_sl_quadrotorAttitudeGuidance(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_sl_quadrotorAttitudeGuidance(SimStruct *S)
{
  SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct *)utMalloc
    (sizeof(SFc2_sl_quadrotorAttitudeGuidanceInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_sl_quadrotorAttitudeGuidance;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_sl_quadrotorAttitudeGuidance;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_sl_quadrotorAttitudeGuidance;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_sl_quadrotorAttitudeGuidance;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_sl_quadrotorAttitudeGuidance;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_sl_quadrotorAttitudeGuidance;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_sl_quadrotorAttitudeGuidance;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_sl_quadrotorAttitudeGuidance;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_sl_quadrotorAttitudeGuidance;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_sl_quadrotorAttitudeGuidance;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_sl_quadrotorAttitudeGuidance;
...
void c2_sl_quadrotorAttitudeGuidance_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_sl_quadrotorAttitudeGuidance(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_sl_quadrotorAttitudeGuidance(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_sl_quadrotorAttitudeGuidance(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_sl_quadrotorAttitudeGuidance_method_dispatcher.\n"
